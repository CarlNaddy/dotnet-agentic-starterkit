...
`LocalDiskFileStoreTests` (`tests/DotnetAgenticStarterkit.Tests/Features/Files/`) —
...
`ListingPhotoServiceTests` (`tests/DotnetAgenticStarterkit.Tests/Features/Listings/`) —
